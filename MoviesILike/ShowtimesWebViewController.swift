//
//  ShowtimesWebViewController.swift
//  MoviesILike
//
//  Created by Andrew Mogg on 11/10/15.
//  Copyright © 2015 Andrew Mogg. All rights reserved.
//

import UIKit

class ShowtimesWebViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let googleQuery = "http://google.com/movies?near=\(location)"
        /*
        ...
        */
        let url = NSURL(string: googleQuery)
