//
//  TheaterWebViewViewController.swift
//  MoviesILike
//
...
class TheaterWebViewViewController: UIViewController, UIWebViewDelegate {

    
    @IBOutlet var webView: UIWebView!
    
    /*
    The upstream view controller VTDirectionsViewController creates the dataObjectToPass
    ...
    */
    override func viewDidLoad() {
        ...
        let mapQuery = dataObjectPassed[0]
        self.title = dataObjectPassed[2]
